...
# FIXME: Doesn't support the custom extension point yet
DEFINED_FIELDS = {
    'title': -1,
    'detail': -2,
    'instance': -3,
...
def decode_problem_details(cbor_data):
    ...
    text_key_data = {key: decoded_data.get(DEFINED_FIELDS[key]) for key in DEFINED_FIELDS if DEFINED_FIELDS[key] in decoded_data}
